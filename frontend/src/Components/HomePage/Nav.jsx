    ...
    <div className="flex flex-row items-center">
      ...
      <div className="flex flex-row justify-between items-center bg-gray-50 p-2 w-full">
        <div className="w-[500px] px-2 flex items-center space-x-2 bg-white mr-14">
          ...
          <input type="search" className="w-full rounded p-2 outline-none" placeholder="Search Library"/>
        </div>
        <div className="px-2">
            <nav>
                <ul className="flex space-x-4 items-center">
                    <li><a href="" className="font-medium mr-2">Explore</a></li>
                    <li><a href="" className="font-medium mr-2">Event</a></li>
                    <li>
                    ...
                    <li><button className="bg-green-500 hover:bg-green-600 px-7 text-green-50 py-2 flex items-center">
                        <AiOutlineCloudDownload type="FaRegular" className="text-2xl mr-2 text-green-50"/>
                      Upload
                    </button></li>
                </ul>
            </nav>
