    ...
    return(
        <div className="flex flex-col items-between min-h-screen text-center max-h-fit w-full max-h-100 h-full object-cover bg-no-repeat bg-cover bg-center" style={heroStyle}>
            ...
            <div className="py-40">
                ...
                <div className="flex lg:flex-row md:flex-row sm:flex-col lg:justify-center md:justify-center sm:items-center lg:items-center md:items-center lg:space-x-20 md:space-x-14 sm:space-y-7">
