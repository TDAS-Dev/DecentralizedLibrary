...
const lpCardContainerstyle = `min-w-screen border-t-10 border-gray-300 flex justify-center`
...
const textpstyle = `text-black lg:text-2xl md:text-2xl sm:text-xl font-light lg:text-left md:text-left sm:text-center font-lato`
const imgStyle = `h-auto lg:w-[50%] md:w-[52%] sm:w-[60%]`

export default LpCardRight;